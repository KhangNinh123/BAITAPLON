...
let spm3 = { masp: 3, loai: "TUI DIOR ", hinhanh: "image/30-montaigne-chain-bag-with-handle-bag-1-300x300.jpg", ngaythang: "12/05/2024", tensp: "Nước Tẩy Trang Garnier Dành Cho Da Dầu Và Mụn 400ml Micellar Cleansing Water For Oily & Acne-Prone Skin New", mota: "Nước Tẩy Trang Garnier Micellar Cleansing Water là dòng sản phẩm tẩy trang nổi tiếng đến từ thương hiệu Garnier của Pháp, sử dụng công nghệ Micelles (Micellar Technology) có chứa các phân tử mi-xen hoạt động theo cơ chế nam châm giúp nhẹ nhàng làm sạch da và lấy đi bụi bẩn, cặn trang điểm và dầu thừa sâu bên trong lỗ chân lông mà không gây khô da.", dongia: "Giá: 139.000vnđ" }
...
function hienthigiaodien() {
    ...
    let menu = "<nav class='navbar navbar-light bg-faded fontroboto'>" +
        ...
        "<img src='image/logo.jpg' alt='' style=' width: 150px; height: 100px;'>"+
    ...
    let footer = "<div class='container'>" +
        ...
        " <span class='textmotdong'>" + "Địa chỉ: 497/24/9M Phan Văn Trị, Quận Gò Vấp, Thành phố Hồ Chí  Minh" + "</span>" +
        " </div>" +
        "<div class='motdong'>" +
        " <i class='fa fa-phone'>" + "</i>" +
        " <span class='textmotdong'>" + "Số điện thoại: 0373246328</span>" +
        "  </div>" +
        "<div class='motdong'>" +
        "<i class='fa fa-envelope-o'>" + "</i>" +
        "<span class='textmotdong'>" + "Email: mtcosmetic@gmail.com</span>" +
        " </div>" +
        " </div>" +
    ...
    let modal = "<div class='modal-dialog'>" +
        ...
        " <h2>Đăng nhập vào MT-Cosmetic</h2>" +
        " </div>" +
...
function HienThiDanhSachSanPhamSapRaMat(spm) {
    let temp = "<div class='col-sm-4 mottintuc'>" +
        ...
        " <div class='ngaythang'>" + " " + spm.ngaythang + " trên" + "<span class='vang'>" + "MT-Cosmetic" + "</span>" + "</div>" +
