...
let sp7 = { masp: 7, hang: "GARNIER", hinhanh: 'image/kemduong-garnier.png', tensp: "Kem dưỡng ban ngày Garnier Light Complete Serum Cream SPF30 50ml", soluong: 1, dongia: "169.000VNĐ", mota: 'Kem dưỡng ban ngày Garnier Light Complete Serum Cream SPF30 50ml là dòng kem dưỡng làm sáng, bảo vệ và dưỡng ẩm cho làn da sạm xỉn, thiếu sức sống và có dấu hiệu lão hóa. Kem dưỡng với khả năng dưỡng sáng, bảo vệ da với SPF 30/PA+++ giúp da căng mọng, tràn đầy sức sống từ sau 3 ngày sử dụng sản phẩm phù hợp với mọi loại da.' }
let sp8 = { masp: 8, hang: "GARNIER", hinhanh: 'image/nuoctaytrang-garnier.png', tensp: "Nước Làm Sạch Và Tẩy Trang Dưỡng Sáng Da Micellar Water Vitamin C GARNIER 400Ml", soluong: 1, dongia: "289.000VNĐ", mota: 'Nước Tẩy Trang Garnier Micellar Cleansing Water là dòng sản phẩm tẩy trang nổi tiếng đến từ thương hiệu Garnier của Pháp, sử dụng công nghệ Micelles (Micellar Technology) có chứa các phân tử mi-xen hoạt động theo cơ chế nam châm giúp nhẹ nhàng làm sạch da và lấy đi bụi bẩn, cặn trang điểm và dầu thừa sâu bên trong lỗ chân lông mà không gây khô da.' }
...
function hienthigiaodien() {
    ...
    let menu = "<nav class='navbar navbar-light bg-faded fontroboto'>" +
        ...
        " </li>" +
        " <li class='nav-item'>" +
        " <a class='nav-link' href='Garnier.html'>" + "Garnier" + "</a>" +
        "</li>" +
        "<li class='nav-item'>" +
...
function HienThiDanhSachTungLoaiSanPham(sp) {
    ...
    for (let i = 0; i < 9; i++) {
        ...
        if (i >= 3 && i < 6) {
            ...
            $("#danhsachsomebymi").append(temp)
            if (i == 5) $("#xemthemsomebymi").append(temp1)
        }
        if (i >= 6 && i < 9) {
            let temp = "<div class='col-sm-4'>" +
                "<div class='motspchuan'>" +
            ...
            $("#danhsachgarnier").append(temp)
            if (i == 8) $("#xemthemgarnier").append(temp1)
        }
